...
?>
  ...
  <script src="../pedidos/buscaCliente.js?v=1.7.2"></script>
  <script src="../pedidos/pedidos.js?v=1.7.2"></script>

  <script src="../pedidos/buscaFornecedor.js?v=1.7.2"></script>
  <script src="../pedidos/buscaProduto.js?v=1.7.2"></script>


  <script src="../pedidos/aumentarQuantidade.js?v=1.7.2"></script>

  <script src="../pedidos/mostrarInfo.js?v=1.7.2"></script>
  <script src="listarProdutos.js?v=1.7.2"></script>
  <script src="salvarEdicao.js?v=1.7.2"></script>
  <script src="../../generalScripts/deleteDiv.js?v=1.7.2"></script>
  <script src="validarBotaoSalvar.js?v=1.7.2"></script>
  
  <script src="avisoSalvar.js?v=1.7.2"></script>
</body>
</html>
