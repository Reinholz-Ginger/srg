...
<head>
    ...
    <link rel="stylesheet" href="salvarInspessao.css?v=1.7.0">
...
<body id="body" class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans" onload="onLoad()">
    ...
    <script src="upload.js?v=1.7.0"></script>
    <script src="apagarImg.js?v=1.7.0"></script>
    <script src="abrirImgHD.js?v=1.7.0"></script>
    <script>
        function reload() {
